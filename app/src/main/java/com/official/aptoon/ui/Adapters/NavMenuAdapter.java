...
public class NavMenuAdapter extends RecyclerView.Adapter<NavMenuAdapter.DrawerItemHolder> {

    // slide menu items
    private List<DrawerItem> items;
    private List<Integer> drawerIcons;
    private Activity activity;
    public NavMenuAdapter(List<DrawerItem>  items, Activity activity) {
        super();
        this.items = items;
    ...
    public DrawerItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NavMenuAdapter.DrawerItemHolder(itemView);
    }
